...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function El(e,t,n){let r=new Float32Array(fl),i=new G(0,1,0);return new rc({name:`SphericalGaussianBlur`,defines:{n:fl,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:kl(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Dl(){return new rc({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:kl(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ol(){return new rc({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:kl(),fragmentShader:`
	...
	`}var Al=class extends Sa{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Us(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
#define LOW_PRECISION`),t}var _d={1:`SHADOWMAP_TYPE_PCF`,3:`SHADOWMAP_TYPE_VSM`};function vd(e){return _d[e.shadowMapType]||`SHADOWMAP_TYPE_BASIC`}var $={301:`ENVMAP_TYPE_CUBE`,302:`ENVMAP_TYPE_CUBE`,306:`ENVMAP_TYPE_CUBE_UV`};function yd(e){return e.envMap===!1?`ENVMAP_TYPE_CUBE`:$[e.envMapMode]||`ENVMAP_TYPE_CUBE`}var bd={302:`ENVMAP_MODE_REFRACTION`};function xd(e){return e.envMap===!1?`ENVMAP_MODE_REFLECTION`:bd[e.envMapMode]||`ENVMAP_MODE_REFLECTION`}var Sd={0:`ENVMAP_BLENDING_MULTIPLY`,1:`ENVMAP_BLENDING_MIX`,2:`ENVMAP_BLENDING_ADD`};function Cd(e){return e.envMap===!1?`ENVMAP_BLENDING_NONE`:Sd[e.combine]||`ENVMAP_BLENDING_NONE`}function wd(e){let t=e.envMapCubeUVHeight;if(t===null)return null;let n=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(2**n,112)),texelHeight:r,maxMip:n}}function Td(e,t,n,r){let i=e.getContext(),a=n.defines,o=n.vertexShader,s=n.fragmentShader,c=vd(n),l=yd(n),u=xd(n),d=Cd(n),f=wd(n),p=rd(n),m=id(a),h=i.createProgram(),g,_,v=n.glslVersion?`#version `+n.glslVersion+`
